...
// A1 is the LDR that when the light greater than the servo will move in clockwise direction
// A0 when the light intensity greater than the servo will move in anticlockwise diection
